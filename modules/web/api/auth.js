...
module.exports = function(req, res, cbot, vk){
	...
	return new Promise(function(resolve, reject){
		request('https://oauth.vk.com/access_token?client_id=5951449&client_secret=th8J06DPWj1Kd4BVU4jH&redirect_uri=http://localhost:8080/api/auth&code='+req.param('code'), function(error, response, body){
			if(!error){
